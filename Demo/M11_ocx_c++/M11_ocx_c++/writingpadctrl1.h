...
//
	...
	BOOL Base64Decode(LPCTSTR fileName, LPCTSTR base64Encode)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR VTS_BSTR ;
		InvokeHelper(0x19, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, fileName, base64Encode);
		return result;
	}
